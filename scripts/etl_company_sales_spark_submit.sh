...
#
# This script submits the company sales ETL job to Spark with Hudi dependencies
################################################################################

set -e  # Exit on error

echo "=========================================="
echo "Company Sales ETL - Spark Submit"
echo "=========================================="

# Configuration
APP_DIR="/app"
CONFIG_FILE="${APP_DIR}/configs/ecomm_prod.yml"
PYTHON_SCRIPT="${APP_DIR}/src/etl_company_sales.py"
...
echo "=========================================="
echo "Company Sales ETL - Completed"
echo "=========================================="
